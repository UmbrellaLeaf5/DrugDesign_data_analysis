...
*   **Общие настройки:**
    *   `verbose_print`: логический флаг, который, когда установлен в `true`, включает подробный вывод в консоль во время выполнения.
    *   `testing_flag`: логический флаг, используемый для целей тестирования (при его включении кол-во скачиваемых становится данных фиксированно и ограничено)
